...
public class DecreaseInventoryQuantityConsumer : BackgroundService
{
    private readonly IMediator _mediator;
    private const string Topic = "decrease_inventory_quantity_topic";
    private readonly IConsumer<Ignore, string> _consumer;
    private readonly CancellationTokenSource _cancellationTokenSource;

    public DecreaseInventoryQuantityConsumer(AppSettings settings, IMediator mediator)
    {
        _mediator = mediator;
        ...
        try
        {
            while (!cancellationToken.IsCancellationRequested)
            {
                try
                {
                    ...
                    _mediator.Send(new DecreaseInventoryQuantityRequest(inventoryQuantityDto), cancellationToken);
                }
